...
\end{problem}
\begin{figure}[h!]
	\hfill \includegraphics[height=2in,width=3in]{resources/lim_sup_prob.png} \hspace*{\fill}  %%% \\hspace \includegraphics{imagefile} \hspace*{\fill} to align iage in center
...
\begin{figure}[hbt!]
	...
	{{\includegraphics[width=2.5in]{resources/cauchy_yes.png} }}%
	\qquad
	\subfloat[A sequence that is not Cauchy.But is bounded]
	{{\includegraphics[width=2.5in]{resources/cauchy_no.png} }}%
...
\begin{figure}[h!]
	...
	{{\includegraphics[width= 2.5in]{resources/uniform_yes.png} }}%
	\qquad
	...
	{{\includegraphics[width= 2.5in]{resources/uniform_no.png} }}%
